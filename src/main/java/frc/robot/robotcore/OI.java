...
import frc.robot.cargointake.teleopcommands.MoveCargoWrist;
import frc.robot.cargointake.teleopcommands.ToggleIntake;
import frc.robot.drivetrain.Drivetrain;
import frc.robot.drivetrain.drivetraincommands.NewShift;
...
import frc.robot.panelclaw.teleopcommands.MoveClawWrist;
import frc.robot.panelclaw.teleopcommands.ToggleChair;
import frc.robot.panelclaw.teleopcommands.ToggleClaw;
import frc.robot.panelclaw.teleopcommands.TogglePeg;
...
public class OI {
    ...
    private OI(){
        leftBumperCmd.whenActive(new Shift());
        YButtonCmd.whenActive(new TogglePeg());
        AButtonCmd.whenActive(new ToggleIntake());
        BButtonCmd.whenActive(new ToggleChair());
        XButtonCmd.whenActive(new ToggleClaw());
        DpadXCmd.whenActive(new MoveClawWrist());
        DpadYCmd.whenActive(new MoveCargoWrist());
